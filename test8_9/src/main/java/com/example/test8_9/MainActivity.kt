    ...
    fun onCheckboxClicked(view: View) {
        if (view is CheckBox) {
            ...
            when (view.id) {
                R.id.checkbox_meat -> {
                    if (checked) {
                        Toast.makeText(this@MainActivity, "고기", Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(this@MainActivity, "고기해제", Toast.LENGTH_SHORT).show()
                    }
                }

                R.id.checkbox_cheese -> {
                    if (checked) {
                        Toast.makeText(this@MainActivity, "치즈", Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(this@MainActivity, "치즈해제", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
